  ...
  return (
    <div className="relative min-h-screen w-full bg-[#08080a] text-white font-sans selection:bg-[#dfff00] selection:text-black">
      ...
      <div className="relative z-10 min-h-screen w-full flex flex-col lg:flex-row">
        ...
        {/* ── LEFT: ATHLETE VISUAL PANEL (Desktop only) ── */}
        <div className="relative hidden lg:flex lg:w-1/2 min-h-screen bg-black flex-col justify-end p-6 sm:p-8 xl:p-12 pb-10 xl:pb-14 overflow-hidden">
          <img
          ...
          <div className="relative z-10 max-w-md">
            <span className="inline-flex w-fit items-center gap-1.5 px-2.5 py-0.5 rounded-full border border-[#dfff00]/40 bg-black/70 backdrop-blur-sm text-[9px] font-bold tracking-[0.1em] text-[#dfff00] uppercase mb-2.5">
